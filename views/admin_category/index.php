...
<section>
    <div class="container">
        <div class="row">
            ...
            <a id="pink-color" href="/admin/category/create" class="btn btn-default back"><i class="fa fa-plus"></i> Добавить категорию</a>
            ...
            <table class="table-bordered table-striped table">
                <tr>
                    <th id="pink-color">ID категории</th>
                    <th id="pink-color">Название категории</th>
                    <th id="pink-color">Порядковый номер</th>
                    <th id="pink-color">Статус</th>
                    <th id="pink-color"></th>
                    <th id="pink-color"></th>
                </tr>
